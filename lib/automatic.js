...
function AutomaticClient(options) {
  ...
  this.token = {access_token:options.access_token};
  return this;
}
...
AutomaticClient.prototype.trips = function(options, callback) {
  ...
  var endpoint = config.api.host + '/trip';
...
AutomaticClient.prototype.vehicles = function(options, callback) {
  if(typeof options === 'function') {
    callback = options;
    options = {};
  }

  var endpoint = config.api.host + '/vehicle';
